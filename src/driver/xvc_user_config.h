...
// debug bridge user configuration
struct db_user_config {
    const char* name;
...
static const struct db_user_config user_configs[] = {
    /////////////////////////////////////////////////////////
    ...
    //  uncomment and modify the entries below.  If name is
    //  empty, only the index will be appended to the
    //  character file:
    //   /dev/xilinx_xvc_driver_0
    //   /dev/xilinx_xvc_driver_1
    //
    //  In this example, the name modifers "tree0" and "tree1"
    //  are appended to the character files as follows:
    //
